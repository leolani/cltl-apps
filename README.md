...
3. this tenant's client half (servers/broker must already be up — do not re-list it here: its project name differs from the client stacks', and Compose would try to re-create the already-running rabbitmq container)
```bash
